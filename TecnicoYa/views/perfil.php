				...
				<div class="modal-body">
					<div class="row">
						<div class="col-md-6">
							...
							<p>Contrase&ntilde;a    <input disabled value="<?php echo $contrasenia ?>" name="contrasenia" maxlength="44" type="password" class="col-md-12 form-control" id="inputPass"></p>
						...
						<div class="col-md-6">
							...
							<p>Direccion 			<input disabled value="<?php echo $usr[7] ?>" name="direccion" maxlength="500" type="text" class="col-md-12 form-control" id="inputDireccion"></p>
